class MessagesController < ApplicationController
  ...
  def edit
    respond_to do |format|
      format.turbo_stream { render turbo_stream: turbo_stream.update(@message, partial: 'messages/form', locals: { message: @message }) }
    end
  end
      ...
      if @message.save
        format.turbo_stream do
          render turbo_stream: [ 
            ...
            turbo_stream.prepend('notice', 'Mensaje creado')
          ]
        end
      ...
      if @message.update(message_params)
        format.turbo_stream {
          render turbo_stream: [
            ...
            turbo_stream.prepend('notice', 'Mensaje actualizado')
          ]
        }
    ...
    respond_to do |format|
      format.turbo_stream do
        render turbo_stream: [
          ...
          turbo_stream.update('message_counter', html: Message.count),
          turbo_stream.prepend('notice', 'Mensaje eliminado')
        ]
      end
